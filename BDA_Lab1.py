...
combine_rdd.saveAsTextFile("Q1_result")
...
monthly_reading.saveAsTextFile("Q2_result")
...
year_temperature.saveAsTextFile("Q3_result")
...
combine_rdd_2.saveAsTextFile("Q4_result")
...
preci_2.saveAsTextFile("Q5_result")
